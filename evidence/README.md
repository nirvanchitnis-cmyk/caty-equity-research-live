...
### primary_sources/CVBF_2025-06-30_10Q.html.gz
...
### primary_sources/WAFD_2025-06-30_10Q.html.gz
...
| 20251018 | 17:23 | Primary source archived | COLB_2025-06-30_10Q.html.gz | SHA256: b8b4c842fcee4753... | ✅ ARCHIVED |
...
1. **Office exposure:** Using "TBD" placeholder until sourced from IR or regulatory data
2. **Peer data:** Estimated market data requires Bloomberg/FactSet confirmation
3. **Historical ACL:** Q3'23 and Q4'23 use derived figures (accounting identity)
4. **FDIC call report:** Property-type mapping is imperfect (owner-occ ≠ pure office)
...
**High Priority:**
1. ✅ ACL bridge complete
2. ⏳ FDIC CRE breakdown (API fix needed)
3. ⏳ Peer comp validation (pull actual 10-Qs for EWBC, CVBF, HAFC)
4. ⏳ IR outreach for office % (if Derek approves)

**Medium Priority:**
5. Earnings call transcript search for office commentary
6. Refine Q3'23 and Q4'23 ACL with direct table extraction
7. Add NPL coverage ratios to ACL bridge
...
**Purpose:** Track all primary source captures, model revisions, and evidence updates with timestamps and hashes

| Date | Time (PT) | Event | Artifact | Hash/Version | Status |
|------|-----------|-------|----------|--------------|--------|
| 2025-10-18 | 1602 | Primary source archived | CATY_Q2_2025_Presentation_20250722.pdf | SHA256: e7dbb3a771ba8a940a766cf19819087a4ee1407722671d415c3cc9cc41a2cba0 | ✅ ARCHIVED |
| 2025-10-18 | 1530 | CRE office status update | CRE_OFFICE_STATUS.md | v2.0 (UNSUBSTANTIATED → CONFIRMED) | ✅ UPDATED |
| 2025-10-18 | 1800 | Capital stress model revision | capital_stress_2025Q2.xlsx | v1.0 (4 tabs, formulas exposed) | ✅ CREATED |
| 2025-10-18 | 1800 | NCO bridge memo | NCO_bridge_2023Q3-2025Q2.md | v1.0 (pre/post office adjustment) | ✅ CREATED |
