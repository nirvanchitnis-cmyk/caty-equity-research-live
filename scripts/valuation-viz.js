...
(function () {
    ...
    function getModuleColors() {
        return {
            ...
            up: getCSSVar('--viz-up-600') || getCSSVar('--success') || '#2E6F3E',
            down: getCSSVar('--viz-down-600') || getCSSVar('--danger') || '#8C1E33',
            neutral: getCSSVar('--viz-neu-600') || getCSSVar('--bar-neutral') || '#4F5B67',
